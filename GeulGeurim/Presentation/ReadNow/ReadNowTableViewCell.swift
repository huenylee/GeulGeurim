...
public final class ReadNowTableViewCell: UITableViewCell {
  ...
  public func configureCell(data: FileItemWrapper) {
  ...
  private func setupUIWithData(data: FileItemWrapper) {
    titleLabel.text = data.file.name
